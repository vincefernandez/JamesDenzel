        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Add Department Accounts</h5>
                ...
                <form>
                        ...
                        <label for="Department">Department</label>
                           <select name="Department" id="Dept">Choose
...
<!-- Change Pass Modal -->
    ...
    <div class="d-flex">
        ...
        <div class="p-2">
            ...
            <button type="button" class="h6 mb-0 text-white-800 btn btn-success" data-toggle="modal" data-target="#exampleModalLong">Add Accounts <i class="fas fa-plus"></i></button>
        </div>
    </div>
    <!-- Page Heading -->
