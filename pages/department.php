...
<div class="container-fluid">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="AddAccounts">Add Department :</h5>
                ...
                <form>
                        <p>
                            <label for="user">Department Name</label>
    ...
    <div class="modal fade" id="EditInfo" tabindex="-1" role="dialog" aria-labelledby="EditInfo" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="EditInfo">Edit Department</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <form>
                        <p>
                            <label for="ACCID">Department ID :</label>
                            <label name="ACCID">123</label>
                        </p>
                        <p>
                            <label for="DeptName">Department Name :</label>
                            <input type="textbox" name="DeptName" value="Office of the Mayor"></label>
                        </p>
                    </form>
                </div>
                <div class="modal-footer">
...
<!-- Change Pass Modal -->
    ...
    <div class="d-flex">
        ...
        <div class="mr-auto p-2">
            <h1 class="h3 mb-0 text-gray-800">Department Table</h1>
