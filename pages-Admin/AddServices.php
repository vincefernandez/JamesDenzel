...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="Dept_Services" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-arrow-left"></i> Back to Services</a>
    </div>
    ...
    <div class="d-sm-flex align-items-left p3 mb-4">
     <button class="btn btn-success" type="button" style="margin: 10px">Add</button>
     <button class="btn btn-success" type="button" style="margin: 10px">Cancel</button>
